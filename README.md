...
1. **Отсутствие скинов**: На данный момент в базе нет таких скинов: Титан GT, Рикошет GT. 
...
2. **"Клоны" танков**: При подмене корпусов на старые ХТ или легаси скины могут появляться летающие "клоны" танков.  
...
2) Скин не сменился  
  ...
  - Если скин всё еще не поменялся проверьте консоль, возможно у вас ошибка в названии пушки/корпуса или скина, в консоли будет ошибка об этом.  
